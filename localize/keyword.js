...
module.exports = {
  ...
  "Tip: Use /btw to ask a quick side question without interrupting Claude's current work":
    "提示：使用 /btw 可以快速提一个临时问题，不会打断 Claude 当前工作",
  "Explore": "探索",
  "Explore project structure": "探索项目结构",
  "Initializing…": "正在初始化…",
  "Hullaballooing…": "正在处理中…",
  "Searching for 1 pattern, reading 3 files…": "正在搜索 1 个模式，读取 3 个文件…",
...
,
  ...
  "thinking for ": "思考耗时 ",
  "Thought for ": "思考耗时 ",
  "Tip: Use /btw to ask a quick side question without interrupting Claude's current work": "提示：使用 /btw 可以快速提一个临时问题，不会打断 Claude 当前工作",
  "Searching for 1 pattern, reading 3 files…": "正在搜索 1 个模式，读取 3 个文件…",
  "(ctrl+o to expand)": "（ctrl+o 展开）",
  "PostToolUse:Read says:": "PostToolUse:Read 提示：",
  "Explore": "探索",
  "Explore project structure": "探索项目结构",
  "Hullaballooing": "忙碌处理中",
  "Hullaballooing…": "正在处理中…",
}
