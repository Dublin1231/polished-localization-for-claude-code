...
Claude Code 自带一个可爱的 Buddy 宠物系统，但默认需要等到特定日期才能解锁。我们提供了一键解锁功能，并且支持从 **19 种宠物**中选择你最喜欢的伙伴！
...
# 安装全部功能并选择第19个宠物（胖猫）
polished-localization-install --buddy=19
```
...
| 参数 | 说明 | 示例 |
|------|------|------|
| `--buddy=N` | 选择第 N 个宠物（1-19） | `--buddy=5` |
